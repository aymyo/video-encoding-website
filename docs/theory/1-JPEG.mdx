...
Which also compress the image, and are commonly used.

### GIF (Graphical Image Interface)

It stores 8 bits per pixel for each image, up to 256 different colors chosen from the 24-bit RGB color space. It uses the file extension ``.gif`` 
