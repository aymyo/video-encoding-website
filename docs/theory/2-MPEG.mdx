...
```
bitRate = width * height * bitDepth * FPS
```
For example, if we have a video with 30fps, 24 bits/pixel and a 480x240 resolution, we will need 82944000 bits per second, or 82.944 Mbps (30 * 480 * 240 * 24) if we dont employ any kind of compression.
