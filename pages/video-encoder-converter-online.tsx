...
const WebTool: NextPage<WebToolProps> = ({ docs }) => {
  ...
  return (
    <Layout>
      ...
      <div className=' min-h-screen relative z-10'>
        ...
        <div className='flex items-center justify-center gap-16 mt-8 flex-wrap-reverse mb-16'>
          <VideoUploader
    ...
    return (
      <div className='relative min-w-256 w-80 flex flex-col justify-start'>
        <h2 className='font-serif text-xl text-left mb-4'>
          ...
          <a className='italic' href='https://ffmpegwasm.netlify.app/'>
            ffmpeg.wasm
          </a>{' '}
